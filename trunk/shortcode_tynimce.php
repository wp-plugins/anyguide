...
if(!class_exists('Anyguide_TinyMCESelector')):

class Anyguide_TinyMCESelector{
	var $buttonName = 'anyguide_snippet_selector';
...
if(!isset($shortcodesAnyGuide)){
	...
	add_action('admin_head', array($shortcodesAnyGuide, 'addSelector'));
}
